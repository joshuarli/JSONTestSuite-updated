This is an updated fork which removes basically everything since the original repo checks in 70+ MB dynamically linked binaries.

I'm also dockerizing the test suite to more easily get finer grained control over execution environments.
